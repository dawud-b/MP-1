...
HD_PWD='C:/Users/zfsalti/488/MP-1/hw/hw.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MP1BD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MP1BD_wrapper.tcl -notrace
