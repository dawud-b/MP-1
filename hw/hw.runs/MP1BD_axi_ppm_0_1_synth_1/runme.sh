...
HD_PWD='C:/Users/zfsalti/488/MP-1/hw/hw.runs/MP1BD_axi_ppm_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MP1BD_axi_ppm_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MP1BD_axi_ppm_0_1.tcl
