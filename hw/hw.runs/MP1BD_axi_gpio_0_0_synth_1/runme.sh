...
HD_PWD='C:/Users/zfsalti/488/MP-1/hw/hw.runs/MP1BD_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MP1BD_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MP1BD_axi_gpio_0_0.tcl
