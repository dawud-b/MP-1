...
#
# Generated by export_simulation on Thu Feb 19 11:00:13 -0600 2026
#
################################################################################
...
'-reset_run' switch to the './MP1BD.sh' script.
...
./MP1BD.sh -noclean_files

For more information on the script, please type './MP1BD.sh -help'.
